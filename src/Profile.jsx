...
<div className="row">
<div className="col-sm-1"><span className="float-left mr-3"><img src="https://bootdey.com/img/Content/avatar/avatar1.png" alt='' className="thumb-lg rounded-circle"/></span>
</div>
